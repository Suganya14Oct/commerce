...
class ProductListState extends Equatable {
  ...
  factory ProductListState.initial(){
    ...
    return ProductListState(products: [
      ...
      Product(name: 'Sparkling fruit Salad', price: 489, image: 'assets/fruit8.jpg',desc: 'Pineapple, Oranges, Strawberries, Green Grapes, Blueberries, White Wine, Lime',id: 17),
...
class ProductList extends StateNotifier<ProductListState> {
  ProductList() : super(ProductListState.initial());

  void setProductList(List<Product> productList) {
    state = state.copyWith(product: productList);
  }
